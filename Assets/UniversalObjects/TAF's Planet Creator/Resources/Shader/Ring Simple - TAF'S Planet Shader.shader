...
Shader "TAF's Planet Shader/Ring - Simple" {
    Properties {
...
/////// Diffuse:
                ...
                float3 diffuseColor = _Surface_var.rgb;
                float3 diffuse = directDiffuse * diffuseColor;
////// Emissive:
                float3 emissive = (_Surface_var.rgb*0.25);
/// Final Color:
                float3 finalColor = diffuse + emissive;
                fixed4 finalRGBA = fixed4(finalColor,_Surface_var.a);
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor * _Surface_var.a,0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
